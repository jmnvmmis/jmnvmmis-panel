  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-500 text-white px-8 py-3 rounded-lg transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              {t('header.logout')}
            </button>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl mb-8 border border-gray-100 dark:border-gray-700">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
            <div>
              <h2 className="text-3xl font-bold font-display text-gray-900 dark:text-white mb-2">{t('dashboard.title')}</h2>
              <div className="flex items-center gap-3">
                <div className="h-px bg-amber-500 w-8"></div>
                <p className="text-gray-600 dark:text-gray-400">Administrador: <span className="font-semibold text-amber-600">{user?.email}</span></p>
                <div className="h-px bg-amber-500 w-8"></div>
              </div>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              >
                <option value="todos">{t('dashboard.filters.allCountries')}</option>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              >
                <option value="todas">{t('dashboard.filters.all')}</option>
                <option value="activas">{t('dashboard.filters.active')}</option>
                <option value="inactivas">{t('dashboard.filters.inactive')}</option>
              </select>
            </div>
        ...
        {loading ? (
          <div className="bg-white dark:bg-gray-800 p-12 rounded-2xl shadow-xl text-center border border-gray-100 dark:border-gray-700">
